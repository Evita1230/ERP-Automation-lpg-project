...
import com.lpg.qa.lpgPages.Godownpageform;
...
//		TestBase.driver.close();
	...
	public void GodownpageTest()  throws InterruptedException{
		...
		gt.verifyMyerpagancycode();
		gt.verifyMyerpusrname();
		gt.verifyMyerppassword();
		gt.verifyMyerploginbtn();
