...
public class NonSVDetailsReport {
			...
			// initialization
			public NonSVDetailsReport(WebDriver driver) {
				...
				public void VerifyandClickonMyerpNonSvdetailReport() {
					 Assert.assertTrue( nonsvdetailreport.isEnabled()," nonsvdetailreport is enabled");
					 Reporter.log("verifyMyerpnonsvdetailreport", true);
					 nonsvdetailreport.click();
				}
